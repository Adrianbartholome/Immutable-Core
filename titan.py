...
# Ensure the System Prompt is injected into the backend call
        ...
        if triggered_cmd:
            ...
            if triggered_cmd == "[COMMIT_SUMMARY]":
                ...
                # 1. Identify the data. 
                # If the user pasted a huge block after the tag, 'memory_text' contains it.
                # We strip the command phrase to get the raw data for the shards.
                ...
                if not clean_data:
                    ...
                    log(f"🔥 TITAN IS BURNING {len(chunks)} SHARDS TO CORE...")
